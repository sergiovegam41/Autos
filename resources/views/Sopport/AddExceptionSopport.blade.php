...
<form action="AddExceptionSopportStore" method="get">
    ...
    <div class="table_a">
        ...
        <div class="item_a">
            ...
            <div class="from">
                ...
                <div class="campo">
                    <p class="label_a">Indique el IMAI</p>

                    <div class="searchBox">

                        <textarea name="imai" id="" ></textarea>
                    </div>
                </div>

                <div class="campo">
                    <p class="label_a">Indique el Asesor</p>

                    <div class="searchBox">

                        <textarea name="asesor" id="" ></textarea>
                    </div>
                </div>

                <div class="campo">
                    <p class="label_a">Indique el Cliente</p>

                    <div class="searchBox">

                        <textarea name="cliente" id="" ></textarea>
                    </div>
                </div>
