...
//			$this->form[] = ['label'=>'Administrador','name'=>'administrator','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','placeholder'=>'Encargado de la tienda'];
	        ...
	        */
            ...
            if (CRUDBooster::getCurrentMethod() == "getIndex") {
                $this->script_js ='
                    // Obtener el elemento "btn_add_new_data"
                    const btnAddNewData = document.getElementById("btn_add_new_data");

                    // Crear un nuevo botón
                    const newButton = document.createElement("button");
                    newButton.innerHTML = "<i class=\"fa fa-whatsapp\"></i>&nbsp;Whatsapp Bots";
                    newButton.classList.add("btn", "btn-sm", "btn-success");


                    // Insertar el nuevo botón al lado del elemento "btn_add_new_data"
                    btnAddNewData.parentNode.insertBefore(newButton, btnAddNewData.nextSibling);

                    newButton.addEventListener("click", function() {
                      window.location.href = "./BotWhatsAppManager";
                    });
                ';
            }
