...
use App\Models\LastOrderNumber;
use App\Models\Pings;
use App\Models\Prospectos;
//use App\Models\SmsUsers;
use App\Models\WhatsAppBots;
...
//       DB::beginTransaction();
        ...
        $five_minutes_ago->modify('-15 minute');
...
//        dd($prospectos);
                    ...
                    if ($turnero_modo == 'lineal') {
                        ...
                        $siguiente = CmsUser::where('available',1)->where(function ($query) {
                            ...
                            $query->where('id_cms_privileges', '=' , CmsUser::Coordinador)
                                  ...
                                  ->orWhere('id_cms_privileges', '=' , CmsUser::Tecnico);
        ...
        $WhatsAppBotsModel = WhatsAppBotsModel::get();

//        dd($WhatsAppBotsModel);

        foreach ( $WhatsAppBotsModel as $e ){
           $resp = BotWhatsApp::ping($e->url);
