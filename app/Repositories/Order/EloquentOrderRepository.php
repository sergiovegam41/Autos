...
//                        }
            ...
            $finalQuantity = $quantityProductOrder - $currentAmountForSaveOrder;
                ...
                if($update == false){
                    ...
                    if($orderDetailAux){
                        $ordersDetailSave = $orderDetailAux->update(
                                [
...
//        dd([ "total_order" => $total_order_number??0, "total_price_neto" => $total_price_neto??0, "total_amount_to_discount"=> $total_amount_to_discount ]);
...
//                $orderApplyDiscountDTO->setDiscount($discount);
                $orderApplyDiscountDTO->setGrandTotal($toDiscountData['total_price_neto'] - ((double)$toDiscountData['total_amount_to_discount'] ));
...
//        dd($toDiscountData['total_amount_to_discount']);
